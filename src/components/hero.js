...
export default function Hero() {
  return (
    <div className='mx-auto hero container'>
        <h5 className='title-name pt-10 md:pt-20 text-2xl'>
        ...
        <div className='desc w-5/12 gap-5 grid'>
            <p className='mt-5'>
            I'm an Indonesia based software developer with a goal-driven creative mindset and passion for learning and innovating. <br/> 
            </p>
            <p>
        ...
        <button className='outline outline-offset-2 bg-blue-300 bg-transparent mt-5 p-3 rounded-md'>
            Contact Me
        </button>
